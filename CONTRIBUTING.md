...
Report bugs at https://github.com/luabida/cookiecutter-python/issues.
...
teste could always use more documentation,
whether as part of the official teste docs,
in docstrings, or even on the web in blog posts, articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at
https://github.com/luabida/cookiecutter-python/issues.
...
Ready to contribute? Here’s how to set up `teste` for local development.

1.  Fork the `teste` repo on GitHub.

2.  Clone your fork locally::

    $ git clone git@github.com:your_name_here/teste.git
